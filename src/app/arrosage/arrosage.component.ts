...
import { PlantService, PlantData } from '../plantes.service';
...
@Component({
  ...
  standalone: true,
  imports: [NavbarComponent, SidebarLeftComponent, ReactiveFormsModule, CommonModule, FormsModule, DeconnexionComponent],
